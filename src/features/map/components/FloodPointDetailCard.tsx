                ...
                <p className="text-xs font-black text-emerald-500 uppercase flex items-center justify-end gap-1.5">
                   ...
                   {precise?.timestamp && (
                     <span className="text-[9px] text-zinc-600 font-bold ml-2">
                       (Última: {new Date(formatApiTimestamp(precise.timestamp)).toLocaleTimeString('pt-BR')})
                     </span>
                   )}
                </p>
             </div>
                           ...
                           <div className="flex items-center gap-4">
                              ...
                              <div>
                                 ...
                                 <p className="text-[8px] font-bold text-zinc-600 uppercase mt-0.5 tracking-tighter">
                                    {sensor.type} • {sensor.distanceKm.toFixed(2)}km • {new Date(formatApiTimestamp(sensor.timestamp)).toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })}
                                 </p>
                              </div>
                           </div>
                           <div className="text-right">
